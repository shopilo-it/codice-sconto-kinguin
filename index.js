 ...
 * Homepage: https://shopilo.it/negozi/kinguin.net
 */

const SHOPILO_URL = "https://shopilo.it/negozi/kinguin.net";
const STORE_NAME  = "Kinguin";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-kinguin)" }
  });
