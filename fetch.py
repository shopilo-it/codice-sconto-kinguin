#!/usr/bin/env python3
"""
Recupero codici sconto Kinguin da shopilo.it
Sursa: https://shopilo.it/negozi/kinguin.net
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/kinguin.net"
STORE_NAME = "Kinguin"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Kinguin da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-kinguin)"
    }
    try:
